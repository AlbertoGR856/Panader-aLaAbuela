...
public enum Articulos {
    ...
    PIZZA_PERICOLOSA(3, "pack de latas de coca-cola ", 3),
    ...
    BOLSITA_CHUCHERIAS(10, "bolsita de chucherías", 1.5),
    RED_BULL(10, "red bull", 2),
    COCA_COLA(11, "coca-cola", 1.7),
    BARRAS_PAN(12, "2 barras de pan", 1);
